...
## Multiple Users and Profiles
  ...
  - **Installed in the owner profile while you work in another profile:** Keep Alive cannot see your activity in the
    ...
    profile is in the foreground and unlocked, which avoids most false alerts. It cannot see activity that happened
    between checks, so a check that finds the device locked can still lead to an alert, and the 'Are you there?'
